...
void Arduino_GFX::clearScreen()
{
    startWrite();  // Start the write transaction
    fillScreen(0x0000);  // Fill screen with black color (0x0000 represents black in RGB565)
    endWrite();  // End the write transaction
}
